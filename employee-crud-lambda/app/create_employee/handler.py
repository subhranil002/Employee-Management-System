...
from common.service import EmployeeService, InvalidEmployeeError
...
def handler(event, context):
    try:
        ...
        return success(201, "Employee created successfully", employee)
        ...
        print(f"Create employee error: {exc}")

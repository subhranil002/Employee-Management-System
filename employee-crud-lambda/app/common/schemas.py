...
class EmployeeCreate(BaseModel):
    ...
    createdBy: str = Field(..., min_length=1, description="ID of the user who created this employee")
    ...
    salary: float = Field(..., ge=0.0, description="Salary must be non-negative")
